...
export function matchDestination(destination) {
  ...
  // ── Gist / OSM city destinations (exact city names from cached_places) ───────
  if (d.includes('baguio'))                                                         return 'Baguio';
  if (d.includes('vigan'))                                                           return 'Vigan';
  if (d.includes('cebu'))                                                            return 'Cebu';
  if (d.includes('davao') && !d.includes('davao oriental'))                         return 'Davao';
  if (d.includes('manila') && !d.includes('new manila'))                            return 'Manila';
  if (d.includes('quezon city') || d.includes('qc') || d.includes('cubao'))        return 'Quezon City';
  if (d.includes('makati') || d.includes('bgc') || d.includes('bonifacio'))        return 'Makati';
  if (d.includes('tagaytay') || d.includes('taal lake'))                            return 'Tagaytay';
  if (d.includes('taal') && !d.includes('tagaytay') && !d.includes('taal lake'))   return 'Taal';
  if (d.includes('batangas') && !d.includes('taal'))                                return 'Batangas';
  if (d.includes('antipolo'))                                                        return 'Antipolo';
  if (d.includes('angeles') || d.includes('clark'))                                 return 'Angeles';
  if (d.includes('san fernando') && d.includes('pampanga'))                         return 'San Fernando';
  if (d.includes('san fernando') && d.includes('la union'))                         return 'San Fernando';
  if (d.includes('san fernando'))                                                    return 'San Fernando';
  if (d.includes('malolos') || d.includes('bulacan'))                               return 'Malolos';
  if (d.includes('calamba'))                                                         return 'Calamba';
  if (d.includes('los baños') || d.includes('los banos'))                           return 'Los Baños';
  if (d.includes('san pablo'))                                                       return 'San Pablo';
  if (d.includes('santa cruz') && d.includes('laguna'))                             return 'Santa Cruz';
  if (d.includes('lucena'))                                                          return 'Lucena';
  if (d.includes('lucban'))                                                          return 'Lucban';
  if (d.includes('tayabas'))                                                         return 'Tayabas';
  if (d.includes('laoag'))                                                           return 'Laoag';
  if (d.includes('batac'))                                                           return 'Batac';
  if (d.includes('cagayan de oro') || d.includes('cdo'))                            return 'Cagayan De Oro';
  if (d.includes('butuan'))                                                          return 'Butuan';
  if (d.includes('zamboanga'))                                                       return 'Zamboanga';
  if (d.includes('lake sebu'))                                                       return 'Lake Sebu';
  if (d.includes('palimbang'))                                                       return 'Palimbang';
  if (d.includes('naga') && d.includes('camarines'))                                return 'Naga';
  if (d.includes('naga'))                                                            return 'Naga';
  if (d.includes('cabanatuan'))                                                      return 'Cabanatuan';
  if (d.includes('maragondon'))                                                      return 'Maragondon';
  if (d.includes('magdiwang') || d.includes('sibuyan'))                             return 'Magdiwang';
  if (d.includes('carcar'))                                                          return 'Carcar';

  // ── Static curated destinations ───────────────────────────────────────────────
  ...
  if (d.includes('ilocos norte') || d.includes('kabigan') || d.includes('pagudpud')) return 'Ilocos Norte';
  if (d.includes('zambales') || d.includes('nagsasa') || d.includes('pundaquit'))  return 'Zambales';
  if (d.includes('leyte') || d.includes('kalanggaman') || d.includes('palompon'))  return 'Leyte';
  if (d.includes('siquijor') || d.includes('cambugahay') || d.includes('salagdoong')) return 'Siquijor';
  if (d.includes('negros') || d.includes('apo island') || d.includes('dumaguete')) return 'Negros Oriental';
  if (d.includes('iloilo') || d.includes('gigantes') || d.includes('carles'))      return 'Iloilo';
  if (d.includes('guimaras'))                                                        return 'Guimaras';
  if (d.includes('camiguin') || d.includes('mambajao') || d.includes('white island')) return 'Camiguin';
  if (d.includes('siargao') || d.includes('sugba') || d.includes('general luna'))  return 'Siargao';
  if (d.includes('puerto princesa') || d.includes('underground river') || d.includes('sabang')) return 'Puerto Princesa';
  if (d.includes('palawan') || d.includes('el nido') || d.includes('coron'))       return 'Puerto Princesa';
  if (d.includes('surigao del norte') || d.includes('sohoton') || d.includes('socorro')) return 'Surigao del Norte';
  ...
  if (d.includes('cagayan') || d.includes('palaui') || d.includes('tuguegarao'))   return 'Cagayan';
  if (d.includes('rizal') || d.includes('masungi') || d.includes('daraitan'))      return 'Rizal';
  if (d.includes('abra') || d.includes('kaparkan') || d.includes('bangued'))       return 'Abra';
  if (d.includes('western samar') || d.includes('langun') || d.includes('gobingob')) return 'Western Samar';
